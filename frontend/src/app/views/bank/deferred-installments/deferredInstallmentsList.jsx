...
import { getDeferredRequestsList } from '../../../services/bankServcies';
import {
    getCities,
    getStates,
    getNeighborhood,
...
class deferredInstallmentsList extends Component {
    state = {
        pagesCount: 0,
        loading: false,
        list: [],
                                                ...
                                                <table id="excel-table" className="display table w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="120">تاريخ التحديث</th>
                                                            <th width="100">تاريخ الحذف</th>
                                                            <th>العمليات</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {list
                                                            ...
                                                            .map((item, ind) => (
                                                                <tr key={ind}>
                                                                    ...
                                                                    <td>{item.estate_type_name}</td>
                                                                    <td>{item.tenant_city_name}</td>
                                                                    ...
                                                                    <td>
                                                                        <div className="d-flex">
                                                                            <OverlayTrigger placement={"top"} overlay={<Tooltip id="tooltip-top">عرض التفاصيل</Tooltip>}>
                                                                                ...
                                                                                <button onClick={() => this.props.history.push(`/deferred-installments/${item.id}`)}
...
export default deferredInstallmentsList;