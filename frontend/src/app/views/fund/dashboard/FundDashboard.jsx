...
import DoughnutChart from "app/views/charts/echarts/DoughnutChart";
import SimpleCard from "@gull/components/cards/SimpleCard";
import { OverlayTrigger, Tooltip } from "react-bootstrap"; //Alert, Dropdown
...
class FundDashboard extends Component {
  state = {
    ...
    loading: false,
    placesNames: ['الشرقية', 'الباحة', 'جازان', 'حائل', 'القصيم', 'الرياض', 'نجران', 'تبوك', 'المدينة المنورة', 'مكه المكرمة', 'عسير', 'الجوف', 'الحدود الشمالية'],
    places: {
      'الشرقية': {
        'requests': 0,
        'offer': 0,
  ...
  updatePageData = () => {
    ...
    // getList(
    //   this.state.listPrams.request_fund,
    //   this.state.listPrams.form_date,
    //   this.state.listPrams.to_date,
    //   this.state.listPrams.time,
    // )
    getList().then(res => {
  ...
  render() {
    ...
    return (
      <div>
        {/* <Trans i18nKey="inputs.name"></Trans> */}
        {loading
          ? <Loading></Loading>
          ...
          : <div className="page-content">
              ...
              <div className="col-lg-6 col-md-12">
                ...
                <div className="card mb-4 places-table">
                  <div className="card-header card-title mb-0 d-flex align-items-center justify-content-between border-0">
                    ...
                    >
                      {!exportAllLoading && <span onClick={() => {
                        this.setState({ exportAllLoading: true });
                        exportexcel([], 'States_analytics_');
                  ...
                  <div className="">
                    <div className="table-responsive">
                      <table id="excel-table" className="table  text-center">
                        <thead>
                          <tr>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12">
                <SimpleCard title="احصائيات الطلبات لهذا العام" className="mb-4">
                  <DoughnutChart chartData={placesNames.map(placeName => { return { 'id': uuid(), 'name': placeName, 'value': places[placeName].requests } })} amounts={placesNames.map(placeName => places[placeName].requests)} />
                </SimpleCard>
              </div>
              <div className="col-lg-6 col-md-12">
                <SimpleCard title="احصائيات العروض لهذا العام" className="mb-4">
                  <DoughnutChart chartData={placesNames.map(placeName => { return { 'id': uuid(), 'name': placeName, 'value': places[placeName].offer } })} amounts={placesNames.map(placeName => places[placeName].offer)} />
                </SimpleCard>
