    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-subheader__toolbar dashcon">
            <div class="kt-subheader__wrapper">
                <a href="#" class="btn kt-subheader__btn-secondary dashbtn">اليوم</a>
                <a href="#" class="btn kt-subheader__btn-secondary dashbtn">يوميين</a>
                <a href="#" class="btn kt-subheader__btn-secondary dashbtn">اسبوع</a>
                <a href="#" class="btn kt-subheader__btn-secondary dashbtn">الكل</a>
                            ...
                            <div class="kt-widget17">
                                ...
                                <div class="kt-widget17__stats">
                                    ...
                                    <div class="kt-widget17__item">
                                        ...
                                        <a href="{{url('providers?user_status=have_active')}}">
                                            <span class="kt-widget17__subtitle">
                                                مكاتب مرقية
                                            </span>
                                        </a>
                            ...
                            <div class="kt-widget17__stats">
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item">
                                        ...
                                        <a href="{{route('admin.fund_requests.index')}}">
                                            <span class="kt-widget17__subtitle">
                                                إجمالي الطلبات
                                            </span>
                                        </a>
                                ...
                                <div class="kt-widget17__items">
                                    ...
                                    <div class="kt-widget17__item">
                                        ...
                                        <a href="{{url('fund/requests?offer_status=dont_have_active_offers')}}}">
                                            <span class="kt-widget17__subtitle">
                                                طلبات ليس لها عروض
                                            </span>
                                        </a>
