...
@section('content')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <!--Begin::Dashboard 1-->
        <div class="kt-subheader__toolbar dashcon">
            <div class="kt-subheader__wrapper">
                <a href="{{url('fund/dashboard?time=today')}}" class="btn kt-subheader__btn-secondary dashbtn">اليوم</a>
                <a href="{{url('fund/dashboard?time=tow_today')}}" class="btn kt-subheader__btn-secondary dashbtn">يوميين</a>
                <a href="{{url('fund/dashboard?time=week')}}" class="btn kt-subheader__btn-secondary dashbtn">اسبوع</a>
                <a href="{{url('fund/dashboard')}}" class="btn kt-subheader__btn-secondary dashbtn">الكل</a>
                            ...
                            <div class="kt-widget17">
                                <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides" style="background-color: #fd397a">
                                    <div class="kt-widget17__chart" style="height:320px;">
                                        ...
                                        <canvas id="kt_chart_activities" width="507" height="216" class="chartjs-render-monitor" style="display: block; width: 507px; height: 216px;"></canvas>
                                    </div>
                                </div>
                                <div class="kt-widget17__stats">
                                    <div class="kt-widget17__items">
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/providers?time='.$time.'')}}">
                                        ...
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/providers?user_status=have_active&time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    مكاتب مرقية
                                                </span>
                                            </a>
                                    ...
                                    <div class="kt-widget17__items">
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/providers?user_status=waite_active&time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    مكاتب بانتظار القبول
                                                </span>
                                            </a>
                                            <span class="kt-widget17__desc">
                                        ...
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/providers?user_status=best_providers&time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    المكاتب الاكثر نشاطا
                                                </span>
                                            </a>
                                            <span class="kt-widget17__desc">
                                ...
                                <div class="kt-widget17__stats">
                                    <div class="kt-widget17__items">
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/requests?time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    إجمالي الطلبات
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/requests?offer_status=have_offers&time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    طلبات لها عروض
                                                </span>
                                            </a>
                                    ...
                                    <div class="kt-widget17__items">
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/requests?offer_status=have_active_offers&time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    طلبات تم ارسال كود التحقق لها
                                                </span>
                                            </a>
                                            <span class="kt-widget17__desc">
                                        ...
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('fund/requests?offer_status=dont_have_active_offers&time='.$time.'')}}}">
                                                <span class="kt-widget17__subtitle">
                                                    طلبات ليس لها عروض
                                                </span>
                                            </a>
                                ...
                                <div class="kt-widget17__stats">
                                    <div class="kt-widget17__items">
                                        ...
                                        <div class="kt-widget17__item">
                                            ...
                                            <a href="{{url('/fund/offer/requests?time='.$time.'')}}">
                                                <span class="kt-widget17__subtitle">
                                                    {{__('views.offers')}}
                                                </span>
                                            </a>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                        ...
                        <div class="kt-portlet__body kt-portlet__body--fluid">
                            <div class="kt-widget20">
                                <div class="kt-widget20__content kt-portlet__space-x">
                                    <a href="{{url('fund/requests?offer_status=complete&time='.$time.'')}}">
                                        <span class="kt-widget20__number kt-font-danger">{{$accept_requests_from_customer}}+</span>
                                    </a>
                                    <span class="kt-widget20__desc">   {{__('طلبات مكتملة')}} </span>
                                </div>
                                <div class="kt-widget20__chart" style="height:130px;">
                                    <canvas id="kt_chart_bandwidth2"></canvas>
                                </div>
