...
function get_admin_menu_list()
{
    return $menu_list = [
        ...
        [
            'url' => route('admin.fund_requests.index'),
            'icon' => 'flaticon2-indent-dots',
            'text' => __('طلبات الصندوق'),
            'is_active' => starts_with(
                request()
                    ->route()
                    ->getName(),
            ...
            'children' => [
                [
                    ...
                    'text' => __('جميع الطلبات المرسلة'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                        'admin.fund_requests.index'
                    ),
                ],
                [
                    'url' => route('admin.fund_requests.index','offer_status=have_offers'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('طلبات استقبلت عروض'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                ...
                [
                    'url' => route('admin.fund_requests.index','offer_status=have_active_offers'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('طلبات معاينة العقار'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                ...
                [
                    'url' => route('admin.fund_requests.index','offer_status=complete'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('الطبات المقبولة'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                ...
                [
                    'url' => route('admin.fund_requests.index','offer_status=rejected_customer'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('الطبات المرفوضة'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                ...
                [
                    'url' => route('admin.fund_sms_status.index'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('مراقبة الطلبات'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                        'admin.fund_sms_status.index'
                    ),
                ],
        ...
        [
            'url' => route('admin.settings.export'),
            'icon' => 'flaticon2-analytics',
            'text' => __('تصدير'),
            'is_active' => starts_with(
                request()
            ...
            'children' => [
                ...
                [
                    'url' => route('admin.settings.export.fund_operation'),
                    'icon' => 'flaticon2-analytics',
                    'text' => __('تصدير عمليات الطلبات'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
        ...
        [
            'url' => route('admin.fund_requests_offer.index'),
            ...
            'children' => [
                ...
                [
                    'url' => route('admin.fund_requests_offer.index','status=sending_code'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('عروض مرسلة البيانات المستفيد'),
                    'is_active' => starts_with(
                        request()
                            ->route()
                            ->getName(),
                ...
                [
                    'url' => route('admin.fund_requests_offer.index','status=accepted_customer'),
                    'icon' => 'flaticon2-image-file',
                    'text' => __('عروض مكتملة'),
                    'is_active' => starts_with(
                        request()
