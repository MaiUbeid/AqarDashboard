...
class LoginController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = '/fund/login';
    protected $redirectToAdmin = 'fund/dashboard';
    ...
    public function redirectPathAdmin()
    {
        ...
        return property_exists($this, 'redirectToAdmin') ? $this->redirectToAdmin : '/fund/home';
    }
    ...
    public function logout(Request $request)
    {
        ...
        return $this->loggedOut($request) ?: redirect('fund/login');
    }
