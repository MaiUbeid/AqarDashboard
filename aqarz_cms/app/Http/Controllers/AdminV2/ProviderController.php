...
class ProviderController extends Controller
{
    public function index()
    {
        ...
        $edit_url = route('admin.providers.edit', 'NaN');
        $active_url = route('admin.providers.active', 'NaN');
    ...
    public function datatable(Request $request)
    {
        ...
        $finiceing = User::where('type', 'provider');
    ...
    public function edit($id)
    {
        ...
        $new_offer = RequestOffer::with('estate', 'user')->where('provider_id', $user->id)->orderBy('id',
            'desc')->limit(10)->get();
    ...
    public function active($id)
    {
        ...
        if (!$requestPayment) {
            \Session::flash('success', trans('المستخدم غير موجود'));

        }


        $requestPayment->is_pay = '1';
        $requestPayment->save();


        \Session::flash('success', trans('تم التفعيل بنجاح بنجاح'));
